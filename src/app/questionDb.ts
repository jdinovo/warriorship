...
export let QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    answers: ['Tai Chi', 'MMA', 'Fencing', 'Chess']
  },
  {
  ...
  },
  {
    ...
    answers: ['New Age', 'Heavy Metal', 'Classical', 'R & B']
  },
  {
  ...
  {
    question: 'The superpower I wish I could have:',
  ...
  },
  {
    ...
    answers: ['Surrender', 'Fight until death',
      'Strategically out-maneuver my enemy, to avoid direct conflict', 'Reformulate my strategy']
  },
  {
    ...
    answers: ['Call for help', 'Slay the assailants',
      'Distract the assailants, so the victim may flee', 'Intimidate the assailants into retreat']
  },
  {
  ...
  },
  {
    ...
    answers: ['Drama', 'Horror', 'Action', 'Mystery']
  },
  {
    question: 'The personality trait I need to improve:',
    answers: ['Humble', 'Volatile', 'Narcissistic', 'Arrogant']
  },
  {
